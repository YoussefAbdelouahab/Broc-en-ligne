...
export default function UserListPage() {
    ...
    const { data, fetchData } = useFetchFaq();
    ...
    const [tmpFaqId, setTmpFaqId] = useState("");
    ...
    const handleDeleteFaq = async () => {
        ...
        if (token) {
            const config = {
                ...
                url: `${process.env.REACT_APP_API_URL}/faq/${tmpFaqId}`,
                headers: {
    ...
    return (
        <>
            <Container>
                <Stack sx={{
                    ...
                    <Stack sx={{
                        ...
                        <Button variant="contained" to={"/intranet/faq/ajouter"} component={RouterLink} sx={{
                            py: 1.25,
                            px: 3,
                            borderRadius: 2,
                            fontWeight: 700,
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <TableCell align="right">
                                                        <IconButton size="large" color="inherit" onClick={(e) => handleOpenMenu(e, faq.id)}>
                                                            <MoreIcon />
                                                        </IconButton>
                                                    </TableCell>
                                                </TableRow>
            ...
            >
                <Link component={RouterLink} to={`/intranet/faq/ajouter?faq=${tmpFaqId}`} sx={{ color: "black", textDecoration: "none" }}>
